 ...
 * 
 * Проверить, выполняются ли требования уже, 
 * если нет доработать код. 
 * 
 * Проверить кейс с удалением, как работает в нем, 
 * если надо доработать требования, потом код 
 * 
 * Если с требованием сложности, сходить в магазин 
 * купить несколько товаров, посмотреть в каком 
 * порядке их пробьют на кассе и как они 
 * располагаются в чеке, понять закономерность
 */